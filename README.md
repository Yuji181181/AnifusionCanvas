...
このデモでは、原画2枚から中割りフレームを生成する「ToonCrafter」といモデルを使用します。生成後、生成物の破綻した箇所だけを SDXL Inpainting で部分修正します。人間のクリエイティビティを活かしながらAI活用を推進する最適なワークフローの模索しています。制作現場で人間の判断を残しながら、AIで作業負荷を下げる Human-in-the-Loop 型のワークフローを検証するために開発しました。
